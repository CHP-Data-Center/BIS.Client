...
export default function TrendingPage() {
  ...
  const displayArticles = useMemo(() => {
    ...
    return list.map(item => {
      ...
      // Ưu tiên bài có điểm xu hướng cao nhất
  ...
  }, [articles, activeTrendingTag, computeItemScore]);
  ...
  }, [activeSourceFilter, displayArticles, adbProjects, wbProjects, procurementItems, canAdb, canWb, canProc, computeItemScore]);
